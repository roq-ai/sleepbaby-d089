...
import { getSleepScheduleById } from 'apiSdk/sleep-schedules';
import { SleepScheduleInterface } from 'interfaces/sleep-schedule';

function SleepScheduleViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('sleep_schedule', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/sleep-schedules/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Sleep Hours" text={data?.sleep_hours} />
