...
export function ReportListPage(props: ReportListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'daily_report', header: 'daily_report', accessorKey: 'daily_report' },
    { id: 'weekly_report', header: 'weekly_report', accessorKey: 'weekly_report' },
    { id: 'monthly_report', header: 'monthly_report', accessorKey: 'monthly_report' },
