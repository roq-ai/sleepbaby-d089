        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Daily Report" text={data?.daily_report} />

                <FormListItem label="Weekly Report" text={data?.weekly_report} />

                <FormListItem label="Monthly Report" text={data?.monthly_report} />
