...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['primary-caregiver', 'secondary-caregiver', 'sleep-consultant'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Babies', path: '/babies', entity: 'baby', service: AccessServiceEnum.PROJECT, icon: FiHeart },
    { name: 'Reports', path: '/reports', entity: 'report', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Sleep Schedules',
      path: '/sleep-schedules',
      entity: 'sleep_schedule',
      service: AccessServiceEnum.PROJECT,
      icon: FiClock,
    },
    { name: 'Sweetspots', path: '/sweetspots', entity: 'sweetspot', service: AccessServiceEnum.PROJECT, icon: FiStar },
