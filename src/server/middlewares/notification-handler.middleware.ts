...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'sleep_schedule.create': {
    roles: ['primary-caregiver', 'secondary-caregiver', 'sleep-consultant'],
    key: 'baby-sleep-schedule-created',
    tenantPath: ['organization', 'baby', 'sleep_schedule'],
    userPath: [],
  },
  'sleep_schedule.update': {
    roles: ['primary-caregiver', 'secondary-caregiver', 'sleep-consultant'],
    key: 'baby-sleep-schedule-updated',
    tenantPath: ['organization', 'baby', 'sleep_schedule'],
    userPath: [],
  },
  'sleep_schedule.delete': {
    roles: ['primary-caregiver', 'secondary-caregiver', 'sleep-consultant'],
    key: 'baby-sleep-schedule-deleted',
    tenantPath: ['organization', 'baby', 'sleep_schedule'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['primary-caregiver'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['primary-caregiver', 'secondary-caregiver', 'sleep-consultant'];
